...
part 'finish.do.exam.page.dart';

class DoExamPage extends StatefulWidget {
	final List<Question> questions;
	final Duration start_duration;
	const DoExamPage({Key key, @required this.questions, @required this.start_duration}) : super(key: key);
	@override
	State<StatefulWidget> createState() => _DoExamPageState();
}
